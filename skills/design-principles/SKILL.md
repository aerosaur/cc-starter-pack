...
description: Enforce a precise, minimal design system inspired by Linear, Notion, and Stripe. Use when building dashboards, admin interfaces, SaaS UIs, or any interface requiring Jony Ive-level precision. Triggers on requests for clean UI, modern design, minimalist interfaces, polished aesthetics, enterprise software design, or mentions of Linear/Notion/Stripe-style design. Every pixel matters.
